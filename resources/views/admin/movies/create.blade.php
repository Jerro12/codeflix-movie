...
@section('content')
<div class="mb-4">
    <h1 class="text-white" style="font-family: 'Kanit', sans-serif; font-size: 32px;">Add New Movie</h1>
    <p class="text-muted">Create a new movie entry</p>
</div>
        ...
        <form action="{{ route('admin.movies.store') }}" method="POST">
                ...
                <div class="col-md-4">
                    <div class="form-group-admin">
                        ...
                        <input type="url" name="poster" id="poster" class="form-control-admin" 
                               value="{{ old('poster') }}" required placeholder="https://...">
                    </div>
            ...
            <div class="d-flex gap-3 mt-4">
                <button type="submit" class="btn-admin-primary">
                    <i class="fa-solid fa-save me-2"></i>Create Movie
                </button>
